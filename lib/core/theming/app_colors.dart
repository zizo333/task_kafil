import 'package:task/core/extensions/string_extension.dart';

class AppColors {
  const AppColors._();

  static final primary = '#1DBF73'.color;
  static final secondary = '#FFCB31'.color;
  ...
  static final cardShadow = '#2020201A'.color.withOpacity(0.1);
